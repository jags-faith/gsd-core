...
try capability registry (dispatchCapabilityCommand)   // toggleable FEATURE capabilities — ADR-959, unchanged
  → try host dispatch table (_dispatchNonFamily)       // all non-capability commands — fills the prepared seam
